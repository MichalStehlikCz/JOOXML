 ...
 */
public final class RXSSFPicture implements Picture {
    private static final POILogger logger = POILogFactory.getLogger(RXSSFPicture.class);
    /**
    ...
    RXSSFPicture(RXSSFWorkbook _wb, XSSFPicture _picture) {
        this._wb = _wb;
    ...
    private float getRowHeightInPixels(int rowIndex) {
        ...
        RXSSFSheet sheet = _wb.getSXSSFSheet(xssfSheet);
