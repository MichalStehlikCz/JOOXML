 ...
 * Only implements support for children. Created to support both geenral data sources and {@code RootDataSource}
 */
public abstract class DataSourceRootAncestor implements ReportDataSource {
     ...
     *
     * @param child is chld data source to be added
    ...
    void addChild(ReportDataSource child) {
        if (child.getParent().
            ...
            throw new RuntimeException("Cannot attach child dataset that points to different parent");
        }
