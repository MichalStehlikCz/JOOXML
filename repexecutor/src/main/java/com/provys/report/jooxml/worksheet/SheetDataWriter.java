...
public class SheetDataWriter implements Closeable {
     ...
     */
    public void writeRow(int rownum, RXSSFRow row) throws IOException {
    ...
    void beginRow(int rownum, RXSSFRow row) throws IOException {
        _out.write("<row");
    ...
    public void writeCell(int columnIndex, Cell cell) throws IOException {
        ...
        switch (cellType) {
            ...
            case FORMULA: {
                ...
                _out.write("</f>");
                // we do not support cached values... otherwise they would have to be written here
                break;
            }
            case STRING: {
