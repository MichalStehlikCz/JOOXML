 ...
 */
interface RowStepBuilder<T extends RowStepBuilder> extends StepBuilder<T> {
     ...
     */
    @Nonnull
    abstract Optional<Integer> getEffFirstRow();
     ...
     */
    @Nonnull
    abstract Optional<Integer> getEffLastRow();
